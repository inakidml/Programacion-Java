    ...
    private void rellenarJTable() {
        ...
        MouseListener tableMouseListener = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                String newEntry = (String)tableModel.getValueAt(row, 0);
        ...
        Object[][] data = {{"uno", "dos", "tres", "cuatro"}, {"cinco", "seis", "siete", "ocho"}};
        String[] colName = {"Tipo", "Fecha", "Duración", "Descripción"};

        jTable1 = new javax.swing.JTable();
        jTable1.addMouseListener(tableMouseListener); //Muy importante listener antes de añadirlo a la vista
