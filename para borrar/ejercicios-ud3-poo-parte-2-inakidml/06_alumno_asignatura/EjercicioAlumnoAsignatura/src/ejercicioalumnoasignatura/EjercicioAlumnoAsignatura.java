        ...
        do {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    System.out.println("En que asignatura quieres matricularlo?");
                    int matricula = Integer.parseInt(br.readLine());
                    
                    alumnos[alumno].addAsignatura(asignaturas[matricula]);
                    asignaturas[matricula].addMatriculado(alumnos[alumno]);
                    break;
                case 4:
                    while (contadorList < indiceAsignatura) {
                        System.out.println(contadorList + " . " + asignaturas[contadorList].getNombre());
                    ...
                    for (int i = 0; i < asignaturas[indiceAsignatura].getIndiceMatriculados(); i++) {//por aqui algo va mal..................
