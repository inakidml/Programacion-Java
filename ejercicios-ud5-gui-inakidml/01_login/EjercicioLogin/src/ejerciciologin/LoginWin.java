...
public class LoginWin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (usuario.equalsIgnoreCase(EjercicioLogin.usuarioGuardado) && passwordString.equals(EjercicioLogin.passwordGuardado)) {
            JOptionPane.showMessageDialog(this, "Login Correcto.");
        }else{
        JOptionPane.showMessageDialog(this, "Error!!", "Login erroneo", JOptionPane.ERROR_MESSAGE);
        }
